<div id="cart">
  ...
  <div class="content">
    ...
    <div class="checkout"><a id="closecart">X</a> | <a href="<?php echo $cart; ?>"><?php echo $text_cart; ?></a> | <a href="<?php echo $checkout; ?>"><?php echo $text_checkout; ?></a></div>
    <?php } else { ?>
    <div class="checkout"><a id="closecart">X</a></div>
    <div class="empty">
      <?php echo $text_empty; ?>
    </div>
    <?php } ?>
