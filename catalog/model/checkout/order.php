	...
	public function confirm($order_id, $order_status_id, $comment = '', $notify = false) {
		...
		if ($order_info && !$order_info['order_status_id']) {
			...
			if ($this->config->get('config_alert_mail')) {
                ...
                $text  = $order_info['firstname'] . " " . $order_info['lastname']. " " . $order_info['shipping_address_1'] . " " . $order_info['shipping_city'] . " " . $order_info['shipping_zone_code'] . " " . $order_info['shipping_postcode'] . "\n\n";
...
//				$text .= "\n";
//
//				$text .= "Tổng cộng: " . $order_total_query->rows[0]['text'];
