...
<div id="content">
	...
	<div class="box">
		...
		<?php foreach ($modules as $module) { ?>
			...
			<table id="layout_sort_<?php echo $module_row; ?>" class="form" style=" <?php if ($module['position'] == 'content_footer') echo 'display:none'; else echo 'display:block';?>" cl > 
